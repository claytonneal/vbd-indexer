...
from vbd_indexer.b3tr.b3tr_events_defs import B3TRRewardEvent, B3TRRewardRawEvent
from vbd_indexer.b3tr.b3tr_proof_parser import parse_reward_proof
from vbd_indexer.utils.units import format_wei


def transform_reward_event(raw_event: B3TRRewardRawEvent) -> B3TRRewardEvent:
    """
    ...
    try:
        ...
        app_name = get_app_name(raw_event.appId)
